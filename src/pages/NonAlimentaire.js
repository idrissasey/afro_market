...
const NonAlimentairePage = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const fetchedProducts = await getDocumentsByField('products', 'categoryId', 'non-alimentaire');
        ...
        return (
            <Container sx={{ py: 6, textAlign: 'center' }}>
                ...
                <Typography variant="h6" sx={{ mt: 2 }}>
                    Chargement des produits non-alimentaires...
                </Typography>
            </Container>
        );
    }
                ...
                {products.length === 0 ? (
                    <Box sx={{ textAlign: 'center', py: 4 }}>
                        <Typography variant="h6">
                            Aucun produit non-alimentaire disponible pour le moment.
                        </Typography>
                    </Box>
                ) : (
...
export default NonAlimentairePage;
