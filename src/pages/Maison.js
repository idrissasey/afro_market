...
const MaisonPage = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const fetchedProducts = await getDocumentsByField('products', 'categoryId', 'maison');
        ...
        return (
            <Container sx={{ py: 6, textAlign: 'center' }}>
                ...
                <Typography variant="h6" sx={{ mt: 2 }}>
                    Chargement des produits pour la maison...
                </Typography>
            </Container>
        );
    }
                ...
                {products.length === 0 ? (
                    <Box sx={{ textAlign: 'center', py: 4 }}>
                        <Typography variant="h6">
                            Aucun produit pour la maison disponible pour le moment.
                        </Typography>
                    </Box>
                ) : (
