...
const BeautePage = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                // Récupérer les produits de la catégorie "beaute"
                const fetchedProducts = await getDocumentsByField('products', 'categoryId', 'beaute');
        ...
        return (
            <Container sx={{ py: 6, textAlign: 'center' }}>
                ...
                <Typography variant="h6" sx={{ mt: 2 }}>
                    Chargement des produits de beauté...
                </Typography>
            </Container>
        );
    }
                ...
                {products.length === 0 ? (
                    <Box sx={{ textAlign: 'center', py: 4 }}>
                        <Typography variant="h6">
                            Aucun produit de beauté disponible pour le moment.
                        </Typography>
                    </Box>
                ) : (
